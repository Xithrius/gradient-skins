...
def main():
    ...
    parser.add_argument(
        "image_path", type=str, nargs="?", help="Where you want to save the skin to."
    )

    parser.add_argument(
        "start_color", type=rgb_tuple, nargs="?", help="The RGB value to start with."
    )

    parser.add_argument(
        "end_color", type=rgb_tuple, nargs="?", help="The RGB value to end with."
    )

    parser.add_argument(
        "--direction", type=str, nargs="?", choices=["h", "v", "hv"], default="v"
    )
